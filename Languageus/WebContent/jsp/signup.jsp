...
<body style = "background-color: orange">
	<div class="container">
		...
		<form id="signupForm" class="form-signin" action="${contextPath }/signup.do" method="post">
			...
			<input type="password" name="pwd" id="inputPassword" value = "${ param.id }" class="form-control placeholder="Password" required>
			...
			<input type="text" name="nickname" id="inputNickName" value = "${ param.name }" class="form-control" placeholder="Nickname" required> <br>
